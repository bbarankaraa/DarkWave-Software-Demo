const Header = () => {
  return (
    <div className='h-100 bg-white flex flex-col text-center p-9'>
        ...
        <p className='text-slate-500 text-xl p-3'>Kullanıcı dostu ve mobil uyumlu bir web siteniz olsun. <br /> Yazılım mühendisleri tarafından sektörde fark yaratabileceğiniz çözümler sunuyoruz.</p>
        <div className='mt-5'>
